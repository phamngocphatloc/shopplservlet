<%-- 
    Document   : home
    Created on : 13 thg 9, 2022, 23:02:14
    Author     : exnpt
--%>
        ...
        <div class="owl-carousel owl-theme owl-product-setting">
          ...
          <div class="item">
            <div class="">
              <div class="product-block">
                <div class="product-img fade-box">
                    <c:url value="/introduce?productId=${o.id}" var="introduceproduct"/>
                  <a href="${introduceproduct}" title="Adidas Ultraboost W" class="img-resize">
                    <img src="${o.img}" alt="Adidas Ultraboost W"
                      class="lazyloaded">
                    <img src="${o.img}" alt="Adidas Ultraboost W" class="lazyloaded">
                  </a>
